...
#pragma warning restore CA2211 // Поля, не являющиеся константами, не должны быть видимыми
        ...
        public static PriorityScheduler GetPriorityScheduler(ThreadPriority threadPriority)
            => threadPriority switch
            {
                ThreadPriority.Highest => Highest,
                ThreadPriority.AboveNormal => AboveNormal,
                ThreadPriority.Normal => Normal,
                ThreadPriority.BelowNormal => BelowNormal,
                ThreadPriority.Lowest => Lowest,
                _ => throw new NotImplementedException(), // Useless
            };
